...
export default class Driver extends Club {
  constructor() {
    ...
    gripGeometry.translate(0, -GRIP_HEIGHT / 2, 0);
    ...
    this.shaft.position.set(0, -SHAFT_HEIGHT / 2 - GRIP_HEIGHT, 0);
    ...
    this.head.position.set(-SHAFT_RADIUS_BOTTOM / 2, -SHAFT_HEIGHT - GRIP_HEIGHT, -DRIVER_THICKNESS / 2);
