...
export default class HoleThree extends Group {
  constructor() {
    ...
    this.greenGroup.position.set(0, 0.01, -HOLE_DISTANCE);
  ...
  placeCoords() {
    ...
    this.teeboxSquare = {
      ...
      right: worldCoords.x - this.teebox.position.z + TEE_BOX_DEPTH,
      front: worldCoords.z + this.teebox.position.x + TEE_BOX_WIDTH / 2,
      back: worldCoords.z + this.teebox.position.x - TEE_BOX_WIDTH / 2,
    };

    const greenX = worldCoords.x - this.greenGroup.position.z;
    const greenZ = worldCoords.z + this.greenGroup.position.x;
    this.greenSquare = {
    ...
    this.holeSquare = {
        left: worldCoords.x - this.fairway.position.z,
        right: worldCoords.x - this.fairway.position.z + FAIRWAY_DEPTH,
        front: worldCoords.z + this.fairway.position.x + FAIRWAY_WIDTH / 2,
        back: worldCoords.z + this.fairway.position.x - FAIRWAY_WIDTH / 2,
    }

    this.holeSquare2 = this.greenSquare;
  }
