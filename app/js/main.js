...
export default class App {
  constructor() {
    ...
    this.windArrow = new Arrow(10, 50, 20, 0x871616);
    ...
    this.hemisphereLight = new THREE.HemisphereLight( 0xe2fdff, 0x383838, 1.4 );
    this.hemisphereLight.position.set(-100, 200, -320);
